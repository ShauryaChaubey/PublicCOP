...
class StudentPieChart extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pieChart =  findViewById(R.id.StudentPieChart);
    ...
    private void countNumber() {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("Type3");
    ...
    private void retrieveData() {
        ...
        {
            ref = FirebaseDatabase.getInstance().getReference().child("Type3").child(Integer.toString(i));
