...
class DomesticPieChart extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_domestic_pie_chart);

        pieChart =  findViewById(R.id.DomesticPieChart);
    ...
    private void countNumber() {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("Type2");
    ...
    private void retrieveData() {
        ...
        {
            ref = FirebaseDatabase.getInstance().getReference().child("Type2").child(Integer.toString(i));
    ...
    private void pieChartFunc() {
        ...
        pieChart.setCenterText("Student's Complaints");
